...
export default function JackConceptArtPage(){

  return (
    <div style={{display: "flex", flexDirection: "column"}}>
      <h1 className="p-5 m-0">Jack Rossi Concept Art</h1>

      <img src="https://firebasestorage.googleapis.com/v0/b/songsmith-7042e.appspot.com/o/Concept%20Art%2FJack%20Rossi%2Fjack-rowan.jpg?alt=media&token=1abdb164-5057-4d16-a8c4-937d5aaebd7c" class="img-fluid" alt=""/>
      <small className="p-4">Jack Rossi – by Rowan Gale Draws</small>
