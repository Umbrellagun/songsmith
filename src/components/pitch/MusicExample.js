...
export default class MusicExamplePage extends React.Component {
  ...
  render(){
    ...
    return (
      <div>
        ...
        <audio id="player" src="../music/hallway-battle.mp3" controls controlsList="nodownload" style={{display: "none"}} onTimeUpdate={()=>{this.initProgressBar()}}>
          <source src="https://firebasestorage.googleapis.com/v0/b/songsmith-7042e.appspot.com/o/Music%2Fhallway-battle.mp3?alt=media&token=d95f5f50-d3b5-4013-8610-9c5c803f7e91" type="audio/mpeg"/>
        </audio>

        <div className="row justify-content-center">
          <div className="col-1"></div>
          <div className="col-10 p-3" style={musicPlayerStyle}>
